    ...
    renderTpl: [
        '<div class="{cls}" id="{id}-innerEl" role="grid">',
            '<div role="presentation" class="{baseCls}-header">',
                ...
                '<div class="{baseCls}-month disable" id="{id}-middleBtnEl">{%this.renderMonthBtn(values, out)%}</div>',
        ...
        '</div>',
        {
            ...
            renderMonthBtn: function(values, out) {
               var ret =  Ext.DomHelper.generateMarkup(values.$comp.monthBtn.getRenderTree(), out);
            }
        }
    ],
