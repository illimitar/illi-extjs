Ext.define('Illi.view.relatorio.movimentacao.listaProduto', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.relatorioMovimentacaoListaProduto',
    title: null,
    itemId: 'relatorioMovimentacaoListaProduto',
    ...
    initComponent: function () {
        ...
        me.store = Ext.create('Illi.store.produto.Produtos', {
            autoDestroy: true,
            storeId: "relatorioMovimentacaoListaProduto",
            proxy: {
                type: 'memory'
            },
            listeners: {}
                        ...
                        items: [
                            {
                                ...
                                listeners: {
                                    ...
                                    specialkey: function (btn, e) {
                                        if (e.getKey() === e.ENTER) {
                                            btn.up("grid").down("#btnIncluirProdutoMovimentacao").fireHandler();
                                        }
                                    }
                                }
                            },
                            {
                                text: 'Incluir',
                                action: 'incluir',
                                itemId: "btnIncluirProdutoMovimentacao",
                                scope: this,
