Ext.define('Illi.view.relatorio.movimentacao.Form', {
    extend: 'Ext.form.Panel',
    alias: 'widget.formRelatorioMovimentacao',
    itemId: "formRelatorioMovimentacao",
    autoScroll: true,
    border: false,
    boderBody: false,
    height: '98%',
                            ...
                            items: [
                                {
                                    ...
                                    itemId: 'modeloRelatorioMovimentacao',
                                    plugins: ['clearbutton'],
                                    name: 'modelo',
                                    tipo: 'MOVIMENTACAO',
                                    allowBlank: false
...
//                            valueField: 'id',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'relatorioMovimentacaoListaProduto',
                            border: false,
                            boderBody: false,
                            height: 250
                        }
