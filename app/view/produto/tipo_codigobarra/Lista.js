Ext.define('Illi.view.produto.tipo_codigobarra.Lista', {
    extend: 'Illi.view.AbstractList',
    alias: 'widget.listaTipoCodigoBarra',
    title: null,
    itemId: 'listaTipoCodigoBarra',
    ...
    initComponent: function() {
        var me = this;
        Ext.apply(me, {
            store: 'produto.TipoCodigoBarras',
            tbar: {
                items: [
                    {
                        text: 'Incluir',
            ...
            dockedItems: [
                {
                    xtype: 'pagingtoolbar',
                    store: Ext.getStore("produto.TipoCodigoBarras"),
                    dock: 'bottom',
                    displayInfo: true
                }
            ]
