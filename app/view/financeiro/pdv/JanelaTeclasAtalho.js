            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        Illi.app.Util.BotaoTeclado("Cadastro de Devolução (CTRL + F8)", "F8", true),
                        Illi.app.Util.BotaoTeclado("Ativa/Desativa Cache (CTRL + SHIFT + C)", "C", true, true),
                        Illi.app.Util.BotaoTeclado("Reinicia Caixa (CTRL + SHIFT + R)", "R", true, true)
                    ]
                },
                {
                    xtype: "panel",
                    ...
                    items: [
                        {
                            xtype: 'tbtext',
                            text: 'Venda Andamento',
                            style: {
                                color: '#157fcc',
                                'font-weight': 'bold'
                            }
                        },
                        Illi.app.Util.BotaoTeclado("Cancelar Venda Atual (F12) ", "F12"),
                        Illi.app.Util.BotaoTeclado("Cheque (F3) ", "F3"),
                        Illi.app.Util.BotaoTeclado("Ticket (F5) ", "F5"),
                        Illi.app.Util.BotaoTeclado("Crediário (F6) ", "F6"),
                        Illi.app.Util.BotaoTeclado("Cancelar Item (DELETE)", "DELETE"),
                        {
                            xtype: 'tbtext',
                            text: 'Geral',
                            style: {
                        ...
                        Illi.app.Util.BotaoTeclado("Configurações Extra", "F11", true, true, true),
                        Illi.app.Util.BotaoTeclado("Confirmar (ENTER)", "ENTER"),
                        Illi.app.Util.BotaoTeclado("Limpar (DEL)", "DELETE"),
                        Illi.app.Util.BotaoTeclado("Cancelar Venda  (CTRL + F12", "F12", true)
