Ext.define('Illi.view.financeiro.tipo_movimentacao.Lista', {
    extend: 'Illi.view.AbstractList',
    alias: 'widget.listaTipoMovimentacao',
    title: null,
    itemId: 'listaTipoMovimentacao',
    ...
    initComponent: function() {
        ...
        Ext.apply(me, {
            ...
            dockedItems: [
                {
                    xtype: 'pagingtoolbar',
                    store: Ext.getStore("TipoMovimentacoes"),
                    dock: 'bottom',
                    displayInfo: true
                }
            ]
